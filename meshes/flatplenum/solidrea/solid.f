...
c      implicit none
      ...
      do iel=1,nelv
          do ifc=1,2*ndim
              ...
              if (id_face.eq.10) then       ! Inlet
                  cbc(ifc,iel,1) = 'v  '
                  cbc(ifc,iel,2) = 't  '
              elseif (id_face.eq.20) then   ! Outlet
                  cbc(ifc,iel,1) = 'v  '
                  cbc(ifc,iel,2) = 't  ' 
              elseif (id_face.eq.30) then   ! Sym plane 1
                  cbc(ifc,iel,1) = 'SYM'
                  cbc(ifc,iel,2) = 'SYM'
              elseif (id_face.eq.40) then   ! Sym plane 2
                  cbc(ifc,iel,1) = 'SYM'
                  cbc(ifc,iel,2) = 'SYM'
      	      elseif (id_face.eq.50) then   ! Inner wall
                  cbc(ifc,iel,1) = 'v  '
                  cbc(ifc,iel,2) = 't  '
      	      elseif (id_face.eq.60) then   ! Outer wall
                  cbc(ifc,iel,1) = 'W  '
                  cbc(ifc,iel,2) = 'I  '
              endif
          enddo
